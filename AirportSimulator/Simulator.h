...
public:
	...
	void show_stats()
	{
		...
		double average_waiting_time = double(landing_queue->get_total_wait()) / double(landing_queue->get_num_served());
		std::cout << " with an average waiting time of " << average_waiting_time << std::endl;
		std::cout << std::endl;
		...
		average_waiting_time = double(departure_queue->get_total_wait()) / double(departure_queue->get_num_served());
		std::cout << " with an average waiting time of " << average_waiting_time << std::endl;
		std::cout << std::endl;
